 ...
 const renderInner = () => (
   <View style={styles.panel}>
    <View style={{alignItems:'center'}}>
      <Text style={styles.panelTitle}>Upload your photo</Text>
 ...
 const renderHeader = () =>(
  <View style={styles.header}>
    <View style={styles.panelHeader}>
      <View style={styles.panelTitle}></View>
    </View>
  </View>
 );
      ...
      <TouchableOpacity onPress={() => this.bs.current.snapTo(0)}>
          <View style={{
            ...
            alignItems:'center',
             ...
             <ImageBackground 
             source={require("../assets/karthi.jpeg")}
             style={{
              height:150,
              width:150,
             }}
             ...
             >
              <View style={{
               ...
               <Icon name="camera" color={"#fff"} size={50} style={{
                opacity:0.7,
                alignItems:'center',
                justifyContent:'center',
                borderColor:"#fff",
             ...
             {/* <Avatar.Image size={200} source={require('../assets/karthi.jpeg')} /> */}
          </View>
        </TouchableOpacity>
         <Text style={{marginTop:30, fontSize: 18, fontWeight:"bold"}}>Karthi</Text>
